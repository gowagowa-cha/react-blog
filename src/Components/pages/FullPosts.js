...
export const FullPosts = () => {
	return (
		<Paper style={{ marginTop: 30, padding: "30px 40px" }}>
			...
			/>
			<p>
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum inventore aliquid voluptatum
				ea eos! Ipsa rem possimus totam. Labore nisi odit deleniti unde commodi quidem corrupti
				nihil beatae dolorum quam.
			</p>
			<Divider />
			<h3>Коментарии (0)</h3>
			<Comments />
			...
			<TextField placeholder='Добавьте новый коментарий...' multiline fullWidth />
